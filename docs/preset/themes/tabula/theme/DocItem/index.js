...
export default function DocItem(props) {
  ...
  // INJECTED-START: rootEditUrl and versionLabels
  const {
    siteConfig: {
      customFields: { versionLabels },
    },
            ...
            <article>
              {versionMetadata.badge && (
                <span className={clsx(ThemeClassNames.docs.docVersionBadge, 'badge badge--secondary')}>
                  {/* CHANGED-START: Custom version labels */}
                  {/* {Version: {versionMetadata.label}} */}
                  Version: {versionLabels[metadata.version] || versionMetadata.label}
                  {/* CHANGED-End: Custom version labels */}
                </span>
              )}

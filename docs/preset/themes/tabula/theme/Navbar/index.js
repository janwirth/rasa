...
import { useThemeConfig, useMobileSecondaryMenuRenderer, usePrevious } from '@docusaurus/theme-common';
// MODIFIED-START: CHANGED IMPORT TO FIX NOT FOUND EXPORT
import { useHistoryPopHandler } from '@docusaurus/theme-common/lib/utils/historyUtils';
import SidebarAbove from '@theme/_tabula/SidebarAbove';
...
import RasaDocsLogo from '@theme/_tabula/RasaDocsLogo';
  ...
  return (
    <div className="navbar-sidebar">
      <div className="navbar-sidebar__brand">
        {/* MODIFIED: swapped `RasaDocsLogo` for `Logo` */}
        {/* 
        <Logo
        ...
        {/* MODIFIED-END: swapped `RasaDocsLogo` for `Logo` */}
      ...
      >
        ...
        <div className="navbar-sidebar__item menu">
          ...
          {/* INJECTED: VERSION DROPDOWN AND SEARCH BAR */}
          <SearchBar />
          <VersionDropdown />
          {/* INJECTED-END */}
    ...
    >
      <div className="navbar__inner">
        ...
        <div className="navbar__items navbar__items--right">
          ...
          {/* MODIFIED: hide search box in navbar
              This seems to be a logical error anyways, because if !hasSearchBarItem evaluates to true, it should be hidden, not shown.
